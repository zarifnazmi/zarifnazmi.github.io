...
function image_setup() {
	...
	function img_three(opts) {
		...
		var disp_textures = {
			tech: { img_name: "tech.webp"},
			abstract: {img_name: "abstract.webp"},
			bricks: {img_name: "bricks.webp"},
			claw: {img_name: "claw.webp"},
			cult: {img_name: "cult.webp"},
			numbers: {img_name: "numbers.webp"},
			pieces: {img_name: "pieces.webp"},
			species: {img_name: "species.webp"},
			waves: {img_name: "waves.webp"},
		}
	...
	var map_url = 'assets/images/effect_maps/'+ config_profile_image_effect +'.webp'
